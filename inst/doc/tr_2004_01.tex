...
Compute expected scores and p-values. This will take approx. 14 seconds. 
Compute q-values. 
...
\begin{Soutput}
Compute vector of observed statistics. 
Compute expected scores and p-values. This will take approx. 7 seconds. 
Compute q-values. 
Compute values for confidence lines. 
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
                   observed   expected candidate       pvalue      qvalue
M27891_at         1.0000000  0.5703928         1 1.402721e-06 0.006378229
J03801_f_at       0.7822519  0.5403129         1 2.805443e-06 0.006378229
D88422_at         0.7772185  0.5239238         1 4.208164e-06 0.006378229
M19045_f_at       0.7713098  0.5083620         1 5.610885e-06 0.006378229
Z15115_at        -0.7557720 -0.5704060         1 7.013606e-06 0.006378229
M83667_rna1_s_at  0.7544589  0.4990852         1 8.416328e-06 0.006378229
M63138_at         0.7533647  0.4908699         1 9.819049e-06 0.006378229
X64072_s_at       0.7485502  0.4845475         1 1.122177e-05 0.006378229
M33195_at         0.7457052  0.4796520         1 1.262449e-05 0.006378229
U22376_cds2_s_at -0.7387023 -0.5409804         1 1.402721e-05 0.006378229
\end{Soutput}
\end{Schunk}
}
...
\begin{Soutput}
Compute vector of observed statistics. 
Compute expected scores and p-values. This will take approx. 11 seconds. 
Compute q-values. 
Compute values for confidence lines. 
\end{Soutput}
\begin{Sinput}
