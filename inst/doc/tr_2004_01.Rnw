...
corr <- twilight.pval(golubNorm,gene,method="spearman",quant.ci=0.99)
corr
@
...
<<>>=
a <- twilight.filtering(golubNorm,id,method="fc",num.perm=50,num.take=10)
dim(a$yperm)
a$test
@
...
<<>>=
b <- twilight.pval(golubNorm,a$yperm[1,],method="fc",yperm=a$yperm)
