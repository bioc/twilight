...
<<echo=FALSE,results=hide>>=
png(filename="tr_2004_01-scores.png",width=600,height=450)
plot(expval,which="scores",grayscale=F,legend=F)
dev.off()
png(filename="tr_2004_01-qvalues.png",width=600,height=450)
...
<<echo=FALSE,results=hide>>=
png(filename="tr_2004_01-corr.png",width=600,height=450)
...
<<echo=FALSE,results=hide>>=
png(filename="tr_2004_01-hist.png",width=600,height=450)
...
<<echo=FALSE,results=hide>>=
png(filename="tr_2004_01-fdr.png",width=600,height=450)
plot(exfdr,which="fdr",grayscale=F,legend=T)
dev.off()
png(filename="tr_2004_01-volcano.png",width=600,height=450)
plot(exfdr,which="volcano")
dev.off()
png(filename="tr_2004_01-effectsize.png",width=600,height=450)
